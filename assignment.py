...
def bfs_path(graph, start, end):
    ...
    while queue:
        ...
        if node == end:
            ...
            return {'path':path, 'totalTime':runtime, 'cost':totalCost}
...
def gbfs(graph, start, goal, heuristic):
    ...
    while open_list:
        ...
        if node == goal:
            ...
            return {'path': path, 'total_g_cost': g_cost[path[-1]]}  # Return total cost of path
    ...
    while open_list:
        ...
        if node == goal:
            ...
            while node is not None:
                ...
                node = parent[node]
            path.reverse()
            return {'path':path, 'gCost':g_cost[goal], 'nodesVisited':len(visited)}
...
while True:
        ...
        if choice == 1:
            ...
            if pathExists == True:
                ...
                print('Calcultion time: ',newbfsData['totalTime'])
                print("Goal cost: ",newbfsData['cost'])
            else:
        ...
        if choice == 2:
            ...
            if pathExists == True:
                ...
                print('Calculation time: ',newdfs['totalTime'])
                print('Goal Cost: ',newdfs['cost'])
            else:
                print("Path not found")
        elif choice == 3:
            pathExists = path_exists(graph,start,goal)
            if pathExists == True:
                ...
                #print('Calculation time: ',gbfs['totalTime'])
                print('Goal Cost: ',gbfsData['total_g_cost'])
            else:
                print("Path not found")
        elif choice == 4:
            pathExists = path_exists(graph,start,goal)
...
results = {
    "A*": a_star(graph, 'A', 'E', heuristic),
    "GBFS": gbfs(graph, 'A', 'E', heuristic),
    "BFS": bfs_path(graph, 'A', 'E'),
    "DFS": dfs_path(graph, 'A', 'E')
}
